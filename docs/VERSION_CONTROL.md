...
## Current status (as of `v4.9.3`, merged)

`main` has V1, V2, V2.1, V2.2, V2.3, V2.4, V3, V3.1, V4, V4.1.1, V4.1,
V4.1.2, V4.2, V4.3, V4.3.1, V4.4, V4.4.1, V4.5, V4.5.1, V4.5.2, V4.6,
V4.6.1, V4.7, V4.8, V4.9, and **V4.9.3** merged in (429/429 passing on
`main`, tagged `v4.9.3`). V4.3 overhauls Rebalance &
...
**In progress: V4.10 (`v4.10-company-fundamentals`)**, not yet merged
into `main`. Adds a new Company Fundamentals page (Analysis section) --
one holding's real income statement/balance sheet/cash flow plus an
...
456/456 tests passing. See `docs/ROADMAP.md`'s V4.10 section for the
full design and bug-fix history.
